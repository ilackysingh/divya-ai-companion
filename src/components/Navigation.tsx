          ...
          <div className="max-w-7xl mx-auto px-6 py-3">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <div className="relative">
                  <div className="w-10 h-10 bg-gradient-to-br from-rose-500 via-pink-500 to-purple-500 rounded-lg flex items-center justify-center shadow-lg">
                ...
                <div>
                  <h1 className="text-lg font-bold text-gray-800">Divya's World</h1>
